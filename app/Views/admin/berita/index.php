    ...
    echo '-';
            ...
            <td><a href="<?= base_url('admin/berita/edit/' . $berita['id_berita']) ?>">
                ...
                <small>
                    ...
                    <?= tanggal_bulan_menit($berita['tanggal_publish']) ?>
                    <br><i class="fa fa-calendar-check"></i> Event: <?= tanggal_bulan_menit($berita['tanggal_event']) ?>
                    <br><i class="fa fa-calendar"></i> Updated: <?= tanggal_bulan_menit($berita['tanggal']) ?>
                </small>
            </td>
            <td><small>
                    <i class="fa fa-tags"></i> <a
                        href="<?= base_url('admin/berita/kategori/' . $berita['id_kategori']) ?>">
                    ...
                    <br><i class="fa fa-home"></i> <a
                        ...
                        else if($berita['jenis_berita']==='Berita') {echo 'Berita';}
                        else if($berita['jenis_berita']==='Profil') {echo 'Profil';}
                        ?>
                    </a>
                </small>
            </td>
            ...
            <td><small>
                    ...
                    <i class="fa fa-check"></i> <a
                        href="<?= base_url('admin/berita/status_berita/' . $berita['status_berita']) ?>">
                        <?= $berita['status_berita'] ?>
                    </a>
                </small>
            </td>
            <td>
                <a href="<?= base_url('berita/read/' . $berita['slug_berita']) ?>" class="btn btn-info btn-sm"
                    target="_blank"><i class="fa fa-eye"></i> Baca</a>
                <a href="<?= base_url('admin/berita/edit/' . $berita['id_berita']) ?>" class="btn btn-success btn-sm"><i
                        class="fa fa-edit"></i></a>
                <a href="<?= base_url('admin/berita/delete/' . $berita['id_berita']) ?>" class="btn btn-dark btn-sm"
