<form action="<?= base_url('admin/berita/edit/' . $berita['id_berita']) ?>" method="post" accept-charset="utf-8"
...
?>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-10">
            <textarea name="isi" class="form-control konten" rows="20"><?= $berita['isi'] ?></textarea>
        </div>
    </div>
